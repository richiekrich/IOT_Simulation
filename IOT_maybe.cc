...
// Removed this line because the file doesn't exist in your NS-3 version
// #include "ns3/simple-device-energy-model-helper.h"

using namespace ns3;
using namespace ns3::energy; // Add this line to simplify energy model usage
...
int main(int argc, char *argv[])
{
    ...
    // Step 7: Install Energy Model on Microcontroller Node
    ...
    // Increase the maximum packet limit
    anim.SetMaxPktsPerTraceFile(1000000); // Adjust the number as needed
